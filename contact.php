        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <h2>Aya Grande Reosrt</h2>
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="index3.php" class="active">Home</a></li>
                      <li><a href="properties.php">Facilities</a></li>
                      <li><a href="property-details.php">Property Details</a></li>
                      <li><a href="contact.php">Contact Us</a></li>
                      <li><a href="room.php"><i class="fa fa-calendar"></i> Book Now</a></li>
                  </ul>   
